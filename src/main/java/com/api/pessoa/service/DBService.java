...
public class DBService{
	...
	public void instanciaBaseDeDados(){
		...
		Endereco endereco3 = new Endereco(null, "Rua Street", "321654-985", "654321", "Cidade", pessoa2,true);
		Endereco endereco4 = new Endereco(null, "Rua de baixo", "321654-00", "1", "Cidade", pessoa2,false);
		
		Pessoa pessoa3 = new Pessoa();
		pessoa3.setNome("Apano");
		pessoa3.setDataNascimento(LocalDate.of(2585, 3, 1));
		Endereco endereco5 = new Endereco(null, "Rua Street", "321654-985", "65", "Cidade", pessoa3,true);
		Endereco endereco6 = new Endereco(null, "Rua Street b", "11321654-985", "65", "City", pessoa3,false);
		...
		pessoa3.getEnderecos().addAll(Arrays.asList(endereco5,endereco6));
